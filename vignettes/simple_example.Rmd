---
title: "Stirring Parallel Jobs in background with {bakerrr}"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Stirring Parallel Jobs with bakerrr}
...
new_stirr <- bakerrr::bakerrr(
  ...
  args_list,
  n_daemons = 4
  # bg_args = list(stdout = "out.log", stderr = "error.log")
) |>
