...
vignette: >
  %\VignetteIndexEntry{Efficient Parallel Job Orchestration with bakerrr}
...
When initiating the stirrer with `bakerrr::bakerrr()`, pass any `callr::r_bg()` arguments to `bg_args` argument as below:
