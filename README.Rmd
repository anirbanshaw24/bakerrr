...
[![Test coverage](https://github.com/anirbanshaw24/bakerrr/actions/workflows/test-coverage.yml/badge.svg)](https://github.com/anirbanshaw24/bakerrr/actions/workflows/test-coverage.yml)
...
You can install the development version of bakerrr from [CRAN]( https://cran.r-project.org/web/packages/bakerrr/index.html) with:

```{r install_bakerrr, eval=FALSE}
...
## Further Help & Documentation
 ...
 - For full documentation, visit the [package website](https://anirbanshaw24.github.io/bakerrr/)
 - API reference: [Reference manual](https://anirbanshaw24.github.io/bakerrr/reference/)
 - Report issues: [GitHub Issues](https://github.com/anirbanshaw24/bakerrr/issues)
